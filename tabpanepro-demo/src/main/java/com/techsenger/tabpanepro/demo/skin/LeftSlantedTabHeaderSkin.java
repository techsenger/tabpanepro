...
public class LeftSlantedTabHeaderSkin  extends AbstractSlantedTabHeaderSkin {
    ...
    private final Insets extraPadding = new Insets(2, 0, 0, 18);

    public LeftSlantedTabHeaderSkin(TabPaneProSkin.TabHeaderContext context) {
        super(context);
    }
    ...
    protected void layoutChildren() {
        ...
        Double[] points = {18.0, 5.0, widthBottom, 5.0, widthBottom, height, 0.0, height};

...
package com.techsenger.tabpanepro.core.inputmap;

import static com.techsenger.tabpanepro.core.inputmap.KeyBinding.OptionalBoolean.*;
...
public class KeyBinding {
    ...
    public final KeyBinding shortcut() {
        KeyCode platformShortcutKey = KeyCode.CONTROL;
        if (Utils.isMac()) {
            platformShortcutKey = KeyCode.META;
        }
        switch (platformShortcutKey) {
            case SHIFT:
                return shift();
